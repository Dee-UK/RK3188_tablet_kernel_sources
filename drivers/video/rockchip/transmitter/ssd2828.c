...
int ssdgetvalue(void)
{
		int ret;
		ret= ssd_read_register(0xb1);
		printk("the ret1 is %x\n",ret);
	
		ret =ssd_read_register(0xb2);
		printk("the ret2 is %x\n",ret);
	
		ret=ssd_read_register(0xb3);
		printk("the ret3 is %x\n",ret);
	
		ret=ssd_read_register(0xb4);
		printk("the ret4 is %x\n",ret);
	
		ret=ssd_read_register(0xb5);
		printk("the ret5 is %x\n",ret);
	
		ret=ssd_read_register(0xb6);
		printk("the ret6 is %x\n",ret);
	
		ret=ssd_read_register(0xb7);
		printk("the ret7 is %x\n",ret);
	
		ret=ssd_read_register(0xb8);
		printk("the ret8 is %x\n",ret);
	
		ret=ssd_read_register(0xb9);
		printk("the ret9 is %x\n",ret);
	
		ret=ssd_read_register(0xba);
		printk("the reta is %x\n",ret);
