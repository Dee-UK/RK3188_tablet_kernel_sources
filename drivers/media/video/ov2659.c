...
#define CONFIG_SENSOR_I2C_SPEED     100000 //350000       /* Hz */
...
static struct reginfo sensor_uxga[] =
{
	...
	{0x3406, 0x01}, 	//awb lst bit[1] manual awb peak
  {0x3503, 0x00},
  ...
  {0x3800, 0x00},
	...
	{0x380d, 0x9f},
	//dummy
	{0x380e, 0x05},//0x04 peak on 20120614
	{0x380f, 0xc6}, //0xd0
	{0x3811, 0x10},
	{0x3813, 0x06},
	{0x3814, 0x11},
...
static int sensor_ioctrl(struct soc_camera_device *icd,enum rk29sensor_power_cmd cmd, int on)
{
	...
	switch (cmd)
	{
        ...
        hrtimer_start(&(flash_off_timer.timer),ktime_set(0, 1800*1000*1000),HRTIMER_MODE_REL);
                    }
			}
            break;
		}
