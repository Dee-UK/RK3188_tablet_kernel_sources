...
bool ov5640_fail = false;
EXPORT_SYMBOL(ov5640_fail);
...
//	{0xffff,0x32},//delay 50ms,//delay 100ms                   
  ...
  {0x4002,0xc5},  //BLC related                  
	...
	{0x3709,0x12},                                 
	{0x370c,0x00},                                 
	//{0x3a02,0x09}, //60HZ max exposure limit MSB   
	//{0x3a03,0x3a}, //60HZ max exposure limit LSB   
	//{0x3a14,0x09}, //50HZ max exposure limit MSB   
	//{0x3a15,0x3a}, //50HZ max exposure limit LSB   
