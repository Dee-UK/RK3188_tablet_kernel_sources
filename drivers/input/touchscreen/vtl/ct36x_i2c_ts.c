/*
 * drivers/input/touchscreen/ct36x_i2c_ts.c
 *
...
#define DRIVER_NAME		"ct36x_i2c_ts"
...
#endif
#endif /* CONFIG_CT36X_CHIP_UPDATE_SUPPORT */
...
static void ct36x_ts_workfunc(struct work_struct *work)
{
	...
	for ( iter = 0; iter < CT36X_TS_POINT_NUM; iter++ ) {
		...
		#if defined(CONFIG_X_REVERSE)
			x = CT36X_TS_ABS_X_MAX - x;
		#endif
		#if defined(CONFIG_Y_REVERSE)
